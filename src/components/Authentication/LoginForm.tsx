  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <form onSubmit={(e) => handleForm(e)} className="flex flex-col">
        <label className="text-xl text-mainWhite font-pbold tracking-wider mt-5">
          Email
        </label>
        <input
          ...
          type="text"
        />
        <label className="text-xl text-mainWhite font-pbold tracking-wider mt-7">
          Password
        </label>
        <input
          className=" outline-none border-0 px-3 h-9 w-full rounded-md mt-1 text-white font-pmedium tracking-widest inputBg hover:"
        ...
        <div className=" mt-7 ">
          ...
          >
            ...
            ></div>
            <p className="ml-2 text-white font-pmedium tracking-wide">
              Remember me
            </p>
          </div>
        </div>
      ...
      <div className="mt-7 flex flex-col gap-1">
        <p className="text-subWhite tracking-wider font-pbold text-center ">
          Dont Have Account?{" "}
          <span className="text-white cursor-pointer relative before:content-'' before:left-0 before:absolute before:w-0 before:h-[2px] before:bottom-[-1.5px] before:rounded-lg before:bg-white hover:before:w-full before:transition-all before:duration-200">
            Register
          </span>
        </p>
